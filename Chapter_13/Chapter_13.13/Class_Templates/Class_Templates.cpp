...
// bisa beda tipe (sama kaya template fungsi aja)
template <typename T>
struct Foo
{
...
int main()
{
	...
	Pair<double> p2{ 5.9,7.3 }; // instantiates Pair<double> and creates object p2
	std::cout << p2.first << ' ' << p2.second << '\n';

	Pair p3{ 7.7,1.3 }; // creates object p3 using prior definition for Pair<double>
...
/*		CARA KERJA COMPILER DI LATAR BELAKANG		*/
/*	#include <iostream>
